(function( blocks, element ) {
    ...
    function registerPluginBlock(blocks, element, pluginId, pluginData) {
        ...
        var iconEl = el('img', { width: pluginData.iconSvg.width, height: pluginData.iconSvg.height, src: pluginData.iconSvg.src });
        ...
        blocks.registerBlockType( pluginId, {
            ...
            edit: function( props ) {
                ...
                function showPopup(shortcode_id) {
                    ...
                    var elem = el('form', { className: 'tw-container' }, el('div', { className: "tw-container-wrap"}, el('span', { className: "media-modal-close", onClick: close}, el("span", { className: "media-modal-icon" })), el('iframe', {src: pluginData.data.shortcodeUrl+ '&callback='+shortcodeCbName + '&edit=' + shortcode_id })));
                    return elem;
                }
                ...
                function showShortcodeList(shortcode) {
                    ...
                    return el( 'form', { onSubmit: chooseFromList }, el( 'div', {}, `Select ${pluginData.title}` ), el( 'select', { value: shortcode, onChange: chooseFromList }, children) );
                }
                ...
                function showShortcodePlaceholder() {
                    ...
                    },"You're not select any gallery. Click to choose gallery");
                }
