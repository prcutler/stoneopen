              ...
              <div class="wd-box-content wd-width-100">
                <div class="wd-group">
                  ...
                  <div class="bwg-flex">
                    ...
                    <input type="submit" class="button-primary" onclick="spider_set_input_value('task', 'save'); spider_set_input_value('recreate', 'resize_image_thumb');" value="<?php echo __('Recreate', BWG()->prefix); ?>" />
                  </div>
        ...
        <div class="bwg-section bwg-flex-wrap">
          <div class="wd-box-content wd-width-100 bwg-flex-wrap">
            <div class="wd-box-content wd-width-50">
              <div class="wd-box-content wd-width-100">
                <div class="wd-group">
                  ...
                  <div class="bwg-flex">
                    <input type="radio" name="thumb_click_action" id="thumb_click_action_1" value="open_lightbox" <?php if ($row->thumb_click_action == 'open_lightbox') echo 'checked="checked"'; ?> onClick="bwg_enable_disable('none', 'tr_thumb_link_target', 'thumb_click_action_1')" /><label for="thumb_click_action_1" class="wd-radio-label"><?php _e('Open lightbox', BWG()->prefix); ?></label>
                    <input type="radio" name="thumb_click_action" id="thumb_click_action_2" value="redirect_to_url" <?php if ($row->thumb_click_action == 'redirect_to_url') echo 'checked="checked"'; ?> onClick="bwg_enable_disable('', 'tr_thumb_link_target', 'thumb_click_action_2')" /><label for="thumb_click_action_2" class="wd-radio-label"><?php _e('Redirect to url', BWG()->prefix); ?></label>
                    <input type="radio" name="thumb_click_action" id="thumb_click_action_3" value="do_nothing" <?php if ($row->thumb_click_action == 'do_nothing') echo 'checked="checked"'; ?> onClick="bwg_enable_disable('none', 'tr_thumb_link_target', 'thumb_click_action_3')" /><label for="thumb_click_action_3" class="wd-radio-label"><?php _e('Do Nothing', BWG()->prefix); ?></label>
                  </div>
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_full_width">
                <div class="wd-group">
                  <label class="wd-label"><?php _e('Full-width lightbox', BWG()->prefix); ?></label>
                  <div class="bwg-flex">
                    <input type="radio" name="popup_fullscreen" id="popup_fullscreen_1" value="1" <?php if ($row->popup_fullscreen) echo 'checked="checked"'; ?> onchange="bwg_popup_fullscreen(1)" /><label for="popup_fullscreen_1" class="wd-radio-label"><?php _e('Yes', BWG()->prefix); ?></label>
                    <input type="radio" name="popup_fullscreen" id="popup_fullscreen_0" value="0" <?php if (!$row->popup_fullscreen) echo 'checked="checked"'; ?> onchange="bwg_popup_fullscreen(0)" /><label for="popup_fullscreen_0" class="wd-radio-label"><?php _e('No', BWG()->prefix); ?></label>
                  </div>
                  <p class="description"><?php _e('Image lightbox will appear full-width if this setting is activated.', BWG()->prefix) ?></p>
                </div>
              </div>
              <div class="wd-box-content wd-width-100" id="tr_popup_dimensions">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_info">
                <div class="wd-group">
            ...
            <div class="wd-box-content wd-width-50">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_comment">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_email">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_captcha">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_comment_moderation">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_fullsize_image">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_download">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_image_count">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_image_cycle">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_addthis_profile_id">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_rate">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_facebook">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_twitter">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_google">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_pinterest">
                <div class="wd-group">
              ...
              <div class="wd-box-content wd-width-100" id="tr_popup_tumblr">
                <div class="wd-group">
              ...
              if ( function_exists('BWGEC') ) {
                ?>
              <div class="wd-box-content wd-width-100" id="tr_popup_ecommerce">
                <div class="wd-group">
