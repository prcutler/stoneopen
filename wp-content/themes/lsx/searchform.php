...
<form role="search" method="get" <?php echo $style; ?> class="search-form form-inline" id="searchform" action="<?php echo home_url('/'); ?>">
	<div class="input-group">
		<input type="search" value="<?php if (is_search()) { echo get_search_query(); } ?>" name="s" class="search-field form-control" placeholder="<?php esc_attr_e('Search', 'lsx'); ?> <?php esc_attr_e(get_bloginfo('name'),'lsx'); ?>">
