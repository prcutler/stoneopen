...
<?php // Do not <a title="delete" href="http://www.niharsworld.com/2008/05/08/how-to-delete-files-permanently-from-hdd/">delete</a> these lines
...
<h6 id="comments-wrap"><?php comments_number('No Comments', 'One Comments', '% Comments' );?> to &#8220;<?php the_title(); ?>&#8221;</h6>
    <div class="navigation">
        ...
        <div class="alignright"><?php next_comments_link() ?></div><br clear="all" />
    </div>
...
<p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out &raquo;</a></p>
    ...
    <p>
    <input type="text" name="<a title="url" href="" id="url" value="<?php echo $comment_author_url; ?>" size="28" tabindex="3" class="textarea" />
